  ...
  var loadMyCartEvent = function(userOptions){
    ...
    var drawTable = function(){
      ...
      $.each(products, function(){
        ...
        var myArray = this.image.split("/", 3);
        var photo=myArray[1]+'/'+myArray[2];
        $cartTable.append(
          
          '<tr title="' + this.summary + '" data-id="' + this.id + '" data-price="' + this.price + '">' +
          '<td class="text-center" style="width: 30px;"><img width="30px" height="30px" src="' + photo + '"/></td>' +
          '<td>' + this.name + '</td>' +
          '<td title="Unit Price">Taka ' + this.price + '</td>' +
          '<td title="Quantity"><input type="number" min="1" style="width: 70px;" class="' + classProductQuantity + '" value="' + this.quantity + '"/></td>' +
          '<td title="Total" class="' + classProductTotal + '">Taka ' + total + '</td>' +
      ...
      $cartTable.append(products.length ?
        ...
        '<td></td>' +
        '<td></td>' +
        '<td><strong id="' + idGrandTotal + '"> Taka </strong></td>' +
        '<td></td>' +
        '</tr>'
    ...
    var showGrandTotal = function(){
      $("#" + idGrandTotal).text("Taka " + ProductManager.getTotalPrice());
    }
    /*
    EVENT
    */
    ...
    $(document).on("input", "." + classProductQuantity, function () {
      ...
      $(this).parent("td").next("." + classProductTotal).text("Taka " + price * quantity);
