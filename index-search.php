					...
					<?php 
						if (isset($_POST['search'])){
							$search= $_POST['search'];
								...
								$q2= "SELECT p.product_id, p.product_title, p.product_price, p.product_desc, p.product_image FROM products p WHERE p.product_title LIKE '%$search%' OR p.product_desc LIKE '%$search%'";
