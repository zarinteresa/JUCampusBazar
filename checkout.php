				...
				<div class="col-lg-3 col-md-3 col-sm-12">
					<div class="card">
						...
						<div class="card-body">
						 ...
						 <h6 class="card-title bg-danger text-white p-2"> Taka <?php echo $items['price'];  ?></h6> 
...
?>
	...
	<div class="text-center text-danger mb-5">
			<button name="payment" class="btn btn-info" >Confirm & Pay <?php echo $tot;?> Taka + Delivery Charge </button>
	</div>
</form>
